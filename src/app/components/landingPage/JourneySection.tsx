      ...
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="relative">
          ...
          {steps.map((step, index) => (
            ...
            >
              {/* Text Card */}
              <div className="w-full lg:w-5/12 p-6 rounded-xl shadow-xl bg-white hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 text-left">
                <div
                  className={`w-16 h-16 flex items-center justify-center rounded-full bg-gradient-to-r ${step.color} text-white text-2xl mb-4`}
                >
                  {step.icon}
                </div>
              ...
              <div className="w-full lg:w-5/12 flex justify-center">
                <div
                  className={`w-48 h-48 rounded-2xl bg-gradient-to-r ${step.color} flex items-center justify-center text-white text-7xl shadow-lg hover:scale-105 transition-transform duration-300`}
                >
                  {step.icon}
                </div>
              </div>
